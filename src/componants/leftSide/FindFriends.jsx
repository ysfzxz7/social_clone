export default function(){
    return (
        <div>
            <h1 className="font-bold text-sm mb-5 border-b-2 px-2">Find friends</h1>
            <ul className="space-y-5">
                {
                    friends.map((friend, i)=>(
                        <li className="flex flex-col space-y-2 " key={i}>
                            <div className="flex items-center space-x-2">
                            <img className="w-10 h-10 rounded-full object-cover" src={friend.img} alt="" srcset="" />
                            <h1 className="font-semibold text-sm text-gray-500">{friend.name}</h1>
                            </div>
                            <div>
                            <button className="bg-blue-300 px-2 py-1 text-sm mx-2 ">Add</button>
                            <button className="bg-gray-200 px-2 py-1 text-sm mx-2 ">Remove</button>
                            </div>
                        </li>
                    ))
                }
